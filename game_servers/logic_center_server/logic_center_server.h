...
# Filename     : logic_center_server.h
# Description  : 
# =======================================================*/
#ifndef __TR_LOGIC_CENTER_SERVER_H__
#define __TR_LOGIC_CENTER_SERVER_H__
...
using LogicCenterParentClass = GameServer;

class LogicCenterServer : public GameServer
{
public:
	LogicCenterServer(int32_t index);
	~LogicCenterServer();
	bool Init() override;
public:
    // 新的连接建立了
...
#endif // __TR_LOGIC_CENTER_SERVER_H__
