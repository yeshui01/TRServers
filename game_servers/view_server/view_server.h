...
# Filename     : view_server.h
# Description  : 
# =======================================================*/
#ifndef __TR_VIEW_SERVER_H__
#define __TR_VIEW_SERVER_H__
...
using ViewParentClass = GameServer;

class ViewServer : public GameServer
{
public:
	ViewServer(int32_t index);
	~ViewServer();
	bool Init() override;
public:
    // 新的连接建立了
