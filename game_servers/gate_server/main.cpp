...
int main(int argc, char* argv[])
{
	...
	std::string log_config = std::string("log_config/gate_server") + std::string(argv[1]) + std::string("_log.properties");
	...
	GateServer gate_server(std::stoi(argv[1]));
	gate_server.RunService();
	return 0;
}
