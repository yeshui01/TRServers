...
# Filename     : data_server.h
# Description  : 
# =======================================================*/
#ifndef __TR_DATA_SERVER_H__
#define __TR_DATA_SERVER_H__
...
using DataParentClass = GameServer;
class DataServer : public GameServer
{
public:
	DataServer(int32_t index);
	~DataServer();
	bool Init() override;
public:
    // 新的连接建立了
