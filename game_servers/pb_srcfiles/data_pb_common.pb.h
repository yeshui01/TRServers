...
class pb_table_field : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protos.pb_table_field) */ {
 public:
  pb_table_field();
  ...
  // @@protoc_insertion_point(class_scope:protos.pb_table_field)
 private:
...
class pb_table_item : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protos.pb_table_item) */ {
 public:
  pb_table_item();
  ...
  const ::protos::pb_table_field& field_list(int index) const;
  ::protos::pb_table_field* mutable_field_list(int index);
  ::protos::pb_table_field* add_field_list();
  ...
  // @@protoc_insertion_point(class_scope:protos.pb_table_item)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  bool _is_default_instance_;
  ::google::protobuf::RepeatedPtrField< ::protos::pb_table_field > field_list_;
...
class pb_data_module : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protos.pb_data_module) */ {
 public:
  pb_data_module();
  ...
  const ::protos::pb_table_item& data_items(int index) const;
  ::protos::pb_table_item* mutable_data_items(int index);
  ::protos::pb_table_item* add_data_items();
  ::google::protobuf::RepeatedPtrField< ::protos::pb_table_item >*
      mutable_data_items();
  const ::google::protobuf::RepeatedPtrField< ::protos::pb_table_item >&
      data_items() const;

  // @@protoc_insertion_point(class_scope:protos.pb_data_module)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  bool _is_default_instance_;
  ::google::protobuf::RepeatedPtrField< ::protos::pb_table_item > data_items_;
...
// optional bool primary = 8;
inline void pb_table_field::clear_primary() {
  primary_ = false;
}
inline bool pb_table_field::primary() const {
  // @@protoc_insertion_point(field_get:protos.pb_table_field.primary)
  return primary_;
}
inline void pb_table_field::set_primary(bool value) {
