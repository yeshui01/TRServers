...
# Filename     : center_frame_handle.h
# Description  : 
# =======================================================*/

#ifndef __CENTER_FRAME_MSG_HANDLE_H__
#define __CENTER_FRAME_MSG_HANDLE_H__
...
class CenterFrameHandler : public IMessageHandler
{
public:
    CenterFrameHandler();
	virtual ~CenterFrameHandler();
    // 绑定消息处理接口
...
public:
    ...
    // 客户端下线
    DECLARE_MSG_HANDLER_FUN(OnCenterUserOffline);
};

#endif // __CENTER_FRAME_MSG_HANDLE_H__